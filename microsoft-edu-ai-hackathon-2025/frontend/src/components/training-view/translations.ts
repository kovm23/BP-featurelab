export const TRAINING_TRANSLATIONS = {
  en: {
    ...
    connectionLost: "Connection to server was lost. Please try again.",
    ...
    predictionSourceClassification: "RuleKit",
  ...
  cs: {
    ...
    connectionLost: "Spojení se serverem bylo přerušeno. Zkuste to prosím znovu.",
