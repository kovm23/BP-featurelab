...
export function Guide({
  ...
  const t = uiLanguage === "en"
    ? {
      ...
      phase2Desc: "Review or edit the feature specification and run extraction on training media. The output is training dataset_X.",
    ...
    : {
      ...
      phase2Desc: "Zkontrolujte nebo upravte specifikaci featur a spusťte extrakci na trénovacích médiích. Výstupem je trénovací dataset_X.",
      phase3Title: "Fáze 3 — Trénování modelu",
      phase3Desc: "Vyberte cílový sloupec z labelů a natrénujte model. Získáte metriky, důležitost featur a pravidla.",
      ...
      phase5Desc: "Spusťte predikce, zkontrolujte použité pravidlo pro každý řádek a vyhodnoťte metriky při nahrání testovacích labelů.",
      ...
      tip3: "Po každé fázi si můžete stáhnout výstupy pro audit a dokumentaci.",
    };
