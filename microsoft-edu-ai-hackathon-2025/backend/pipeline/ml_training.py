...
This module is the dispatcher that merges feature/label tables and routes into
the regression branch (`pipeline.ml_regression`) or classification branch
(`pipeline.ml_classification`) depending on `pipeline.target_mode`.
